...
Минусы
 - для передачи метрик необходимо настраивать каждый агент отдельно
...
Минусы
 - при отключения сервера мониторинга или проблемах с сетью, можно потерять данные за все время пока проблемы не будут устранены
